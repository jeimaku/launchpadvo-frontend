  ...
  const getNextAutomatedEmail = () => {
    ...
    if (contract_status === 'Active') {
        ...
        if (daysLeft > 0 && daysLeft <= 30) {
            ...
            return { 
                text: `Next Renewal Ping on ${nextPingDate.toLocaleDateString()}`, 
    ...
    if (contract_status === 'Expired' || contract_status === 'Pending Renewal') {
        ...
        termNotice.setDate(termNotice.getDate() + 30); 
    ...
    <div className="flex min-h-screen bg-slate-50 font-sans">
      ...
      <div className="flex-1 p-8 overflow-hidden flex flex-col h-screen">
        <header className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-4 shrink-0">
          <div>
            <h2 className="text-3xl font-black text-slate-800 tracking-tight">LPOG Virtual Office</h2>
